...
%run vision-4.1\rvctools\startup_rvc.m
...
%m ake a 3D point in the camera frame
P = [0.3, 0.4, 3.0]';
...
cam.project(P, 'pose', transl(-0.5, 0, 0) )
pause;
...
P = mkgrid(3, 0.2, 'pose', transl(0, 0, 1.0));
...
cam.plot_camera('pose', inv(T_est))
grid on